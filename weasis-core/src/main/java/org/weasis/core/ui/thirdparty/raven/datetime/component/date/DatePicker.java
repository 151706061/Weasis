...
public class DatePicker extends JPanel {
    ...
    return new PanelMonth.EventMonthChanged() {
      ...
      public void monthSelected(int month) {
        ...
        panelSlider.addSlide(
            createPanelDate(month, year),
            SimpleTransition.get(SimpleTransition.SliderType.DOWN_TOP));
        panelSelect = 0;
      }
    };
  }
  ...
  public void setToBack() {
    if (panelSelect == 0) {
      ...
      header.setDate(month, year);
      panelSlider.addSlide(
          createPanelDate(month, year), SimpleTransition.get(SimpleTransition.SliderType.BACK));
    } else if (panelSelect == 1) {
      year--;
      header.setDate(month, year);
      panelSlider.addSlide(
          createPanelMonth(month, year), SimpleTransition.get(SimpleTransition.SliderType.BACK));
    } else {
      PanelYear panelYear = (PanelYear) panelSlider.getComponent(1);
      panelSlider.addSlide(
          createPanelYear(panelYear.getYear() - PanelYear.YEAR_CELL),
          SimpleTransition.get(SimpleTransition.SliderType.BACK));
    }
  }
  ...
  public void setToForward() {
    if (panelSelect == 0) {
      ...
      header.setDate(month, year);
      panelSlider.addSlide(
          createPanelDate(month, year), SimpleTransition.get(SimpleTransition.SliderType.FORWARD));
    } else if (panelSelect == 1) {
      year++;
      header.setDate(month, year);
      panelSlider.addSlide(
          createPanelMonth(month, year), SimpleTransition.get(SimpleTransition.SliderType.FORWARD));
    } else {
      PanelYear panelYear = (PanelYear) panelSlider.getComponent(1);
      panelSlider.addSlide(
          createPanelYear(panelYear.getYear() + PanelYear.YEAR_CELL),
          SimpleTransition.get(SimpleTransition.SliderType.FORWARD));
    }
  }
  ...
  public void selectMonth() {
    if (panelSelect != 1) {
      ...
      panelSlider.addSlide(
          createPanelDate(month, year), SimpleTransition.get(SimpleTransition.SliderType.DOWN_TOP));
      panelSelect = 0;
    }
  }
  ...
  public void selectYear() {
    if (panelSelect != 2) {
      panelSlider.addSlide(
          createPanelYear(year), SimpleTransition.get(SimpleTransition.SliderType.TOP_DOWN));
      panelSelect = 2;
    } else {
      panelSlider.addSlide(
          createPanelDate(month, year), SimpleTransition.get(SimpleTransition.SliderType.DOWN_TOP));
  ...
  public void slideTo(LocalDate date) {
    ...
    if (year != y || month != m) {
      if (year < y || (year <= y && month < m)) {
        panelSlider.addSlide(
            createPanelDate(m, y), SimpleTransition.get(SimpleTransition.SliderType.FORWARD));
      } else {
        panelSlider.addSlide(
            createPanelDate(m, y), SimpleTransition.get(SimpleTransition.SliderType.BACK));
      }
      month = m;
      year = y;
      panelSelect = 0;
      ...
      if (panelSelect != 0) {
        panelSlider.addSlide(
            createPanelDate(m, y), SimpleTransition.get(SimpleTransition.SliderType.DOWN_TOP));
        panelSelect = 0;
      }
    }
    updateSelected();
